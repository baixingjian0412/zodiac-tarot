  ...
  container.innerHTML = `
    <div class="daily-tarot-card">
      ...
      <div class="dt-reading">
        <strong style="color:var(--accent-gold)">📜 今日启示</strong><br>
        ${card.reading}
      </div>

      <div class="dt-sections">
        <div class="dt-section-box">
          <h5>💖 爱情</h5>
          <p>${card.love || '暂无'}</p>
        </div>
        <div class="dt-section-box">
...
const LIFE_PATH_DESC = [
  { num: 1, title: '开创者',
    desc: '你天生是领导者，独立自主，富有创造力和决心。你的使命是开创先河，引领他人。独立、自信、勇敢是你的关键词。' },
  { num: 2, title: '协作者',
    desc: '你天生是和平使者，善解人意，富有合作精神。你的使命是建立桥梁，促进和谐。温柔、敏感、善于沟通是你的天赋。' },
  { num: 3, title: '表达者',
    desc: '你天生充满创意和表达欲，乐观开朗，富有感染力。你的使命是用文字、艺术或任何形式分享你的才华。' },
  { num: 4, title: '建造者',
    desc: '你天生务实可靠，注重细节，意志坚定。你的使命是建立稳固的基础，用勤奋和执着创造持久的价值。' },
  { num: 5, title: '探险者',
    desc: '你天生热爱自由，追求变化和冒险，适应力极强。你的使命是体验丰富多彩的人生，用你的经历启发他人。' },
  { num: 6, title: '守护者',
    desc: '你天生充满爱心和责任感，关爱他人，重视家庭。你的使命是用爱和关怀温暖这个世界。' },
  { num: 7, title: '探索者',
    desc: '你天生喜欢探寻真理，思维深邃，富有智慧。你的使命是深入探索生命和宇宙的奥秘。' },
  { num: 8, title: '实现者',
    desc: '你天生具有商业头脑和领导才能，目标明确，执行力强。你的使命是在物质世界取得成就，并用影响力造福社会。' },
  { num: 9, title: '博爱者',
    desc: '你天生具有博大的胸怀和悲悯之心，智慧圆融，无私奉献。你的使命是用智慧和爱服务全人类。' }
];
